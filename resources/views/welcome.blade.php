...
<div>
  ...
  <div class="troicard pb-20 -mt-20  bg-gray-300 overflow-hidden ">
        ...
        <div class="py-6 border-spacing-2 bg-gray-300 rounded-t-lg"  data-aos="zoom-in-up" data-aos-duration="2000" >
...
<div class=" mt-6 py-6 border-spacing-2 bg-gray-300 rounded-t-lg"  data-aos="zoom-in-up" data-aos-duration="2000" >
          <form class="max-w-md mx-auto p-4" action="{{ route('suggest.book') }}" method="post">
            @csrf
            <h3 class="  text-2xl font-semibold text-gray-600 ">{{ __('public.Suggest_adding_a_book') }} :</h3>
            <div class="mb-5 mt-5 ">
