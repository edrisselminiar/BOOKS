...
<body class="antialiased bg-gray-200">
  ...
  <header class="fixed w-[100%] flex flex-wrap items-center px-6 py-2 bg-white lg:px-16 lg:py-0 z-50">
    ...
    <main>
      <div class="relative pt-16 pb-32 flex content-center items-center justify-center  " style="min-height: 75vh;" >
        ...
        <div class="textimg container relative mx-auto">
          <div class="items-center flex flex-wrap">
            <a href="{{ url('/book') }}" class="w-full lg:w-8/12 px-4 ml-auto mr-auto text-center">
      ...
      <section class="troicard pb-20 -mt-20  bg-gray-300 overflow-hidden ">
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap">
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-6/12 lg:w-4/12 px-4 text-center">
              <div
            ...
            <div class="pt-6 w-full md:w-full lg:w-4/12  px-4 text-center">
              <div
                class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"
              >
                <div class="px-4 py-5 flex-auto">
        ...
        <div class=" w-full mt-28 ">
            ...
            <p class="ml-6 text-2xl font-semibold text-gray-600">{{ __('public.The_best_books_on_our_site') }}:</p>
            ...
            <swiper-container class="mySwiper " pagination="true" effect="coverflow" grab-cursor="true" centered-slides="false"
              ...
              coverflow-effect-modifier="0.3" coverflow-effect-slide-shadows="true">
            ...
            <swiper-slide class="relative">
              ...
              <img class="p-2" src="/books/img/{{ $book->img }}"  alt="...">
                        <div  class="absolute text-5xl text-white top-1/2 mt-10 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            <p class="ml-6 text-2xl font-semibold text-gray-600 ">{{ __('public.Discover_more_books') }} 
          ...
          <div class="items-center flex flex-wrap">
            <div class="w-full md:w-6/12 ml-auto mr-auto px-4">
              ...
              <div class="slider2 mb-8">
                        ...
                        @foreach ($books as $book)
                          <swiper-slide>
                            <a href="{{ route('book.show',$book->id) }}">
                              <img alt="..." class="max-w-full rounded-lg shadow-lg card-img-top" src='/books/img/{{ $book->img }}' />
                            </a>
                          </swiper-slide>
                        @endforeach
                        </swiper-container>
            ...
            <div class="w-full md:w-6/12 ml-auto mr-auto px-2 mt-2">
              <div class="md:pr-12 mt-2">
                ...
                <p class="mt-4 mb-4 text-gray-500 dark:text-gray-400 text-lg leading-relaxed text-center" >{{ __('public.Our_site_is_a_treasure_trove') }}</p>
                <p class="text-gray-500 mb-4 dark:text-gray-400 text-lg leading-relaxed text-center">{{ __('public.But_thats_not_all') }}  </p>
                <p class="text-gray-500 dark:text-gray-400 text-lg leading-relaxed text-center ">{{ __('public.So_go_ahead') }} 📚</p>
      ...
      <section class=" mt-6 py-6 border-spacing-2 bg-gray-300 rounded-t-lg">
