...
<body class="antialiased  bg-gray-200 ">
   ...
   <header class="fixed mb-2 w-[100%] flex flex-wrap items-center px-6 py-2 bg-white lg:px-16 lg:py-0 z-50" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="600" >
      @include('resourses.navbar')
   </header>

    <div class="pt-16 ">

        <div class="container max-w-xXl px-3 mx-auto space-y-6 lg:px-8 lg:max-w-7xl ">
            ...
            @endif
                ...
                <div>
                    <div class=" space-y-12 text-nowrap text-center ">
                        <div class=" mt-4">
                            <h4 class="text-lg font-medium leadi ">{{ __('public.Book_name') }} : <span
                                    class=" text-gray-700">{{ $book->title }}</span></h4>
                        </div>
                        <div class="mt-4">
                            <h4 class="text-lg font-medium leadi ">{{ __('public.Author_of_the_book') }} : <span
                                    class=" text-gray-700"> {{ $book->author }}</span></h4>
                        </div>
                        <div class=" mt-4">
                            <h4 class="text-lg font-medium leadi ">{{ __('public.Book_type') }} : <span
                                    class=" text-gray-700"> {{ $book->type }}</span></h4>
                        </div>
                        <div class=" mt-4">
                            <h4 class="text-lg font-medium leadi ">{{ __('public.Number_of_book_pages') }} : <span
                                    class=" text-gray-700"> {{ $book->number }}</span></h4>
                        </div>
                        <div class=" mt-4">
                            <h4 class="text-lg font-medium leadi ">{{ __('public.Book_size') }} : <span
                                    class=" text-gray-700"> {{ $book->size }} MO</span></h4>
                        </div>

                        <div class=" pb-3">
                            <a href="{{ route('book.getDownload', $book->id) }}"
                                class=" bg-gray-300 hover:bg-gray-600 text-gray-800 font-bold py-2 pl-10 pr-10 rounded inline-flex items-center ">
                            ...
                            <a href="{{ route('book.readonline', $book->id) }}"
                                class=" bg-gray-300 hover:bg-gray-600 text-gray-800 font-bold py-2 pl-10 pr-10 rounded inline-flex items-center ">
        ...
        <div class="w-full bg-white rounded-lg p-4 mt-4 pb-4" >
                              ...
                              <p>{{ $review->user->name }}<time datetime="2014-08-16 19:00" class="block text-sm text-gray-500 dark:text-gray-400">Joined on August 2014</time></p>
                                  ...
                                  @method('PUT')
                                          ...
                                          <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                              <div class="relative  w-full max-w-xl ">
                                                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                      <div class=" bg-gray-200 text-center items-center justify-center  rounded-lg">
                                                          <div class="row p-2">
                                                          
                                                              <div class="mt-4">
                                                                  <p class=" font-bold ">edite Review</p>
                                                              </div>
                                                              <div>
                                                                  <div class="rate ml-6 ">
                                                              ...
                                                              <div class="mt-4 mx-2">
                                                                  <textarea id="message" name="review" rows="2" class=" text-start block  mt-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..." required>
                                                                          {{ $review->review }}
                                                                  </textarea>
                                                              </div>
                                                              <div class="justify-end items-end text-end flex">
                                                              <button type="button" class="text-gray-500 bg-white hover:bg-gray-100  font-bold focus:ring-4 focus:outline-none focus:ring-blue-300  rounded-lg text-sm mr-2 px-4 py-2 my-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " data-modal-hide="authentication-modal">
                                                                  cancel
                                                                  <span class="sr-only">Close modal</span>
                                                              </button>
                                                              <div>
                                                                  <button type="submit"  class="  bg-gray-500 hover:bg-gray-600 text-white font-bold focus:ring-4 focus:outline-none focus:ring-blue-300  rounded-lg text-sm mr-2 px-4 py-2 my-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> edite Rating</button>
                                                              </div>
                                                              </div>
                                      ...
                                      <form action="{{ route('reviews.destroy', $review) }}" method="POST">
                                          @csrf
                                          @method('DELETE')
                                              <button  type="button"   data-modal-target="delete-modal" data-modal-toggle="delete-modal" class="text-sm h-8 ml-2 py-0 px-2 bg-gray-300 hover:bg-gray-500 text-gray-800 rounded inline-flex items-center">
                                                  delete
                                              </button>
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="{{ url('/book') }}"
                                    class="hover:underline">{{ __('public.All_Books') }}</a>
                            </li>
                            <li class="mb-4">
                                <a href="{{ route('book.getDownload', 71) }}" class="hover:underline">
                                    {{ __('public.my_CV') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                            {{ __('public.Follow_me') }}</h2>
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="https://github.com/edrisselminiar"
                                    class="hover:underline ">{{ __('public.Github') }}</a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/driss-elminiar-22537723a/"
                                    class="hover:underline">{{ __('public.Linkedin') }}</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <span
                        class="text-gray-800"> Driss Elminiar</span>
                </span>
            </div>
        </div>
    </footer>
