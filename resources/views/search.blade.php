...
<body class="antialiased  bg-gray-200">
  ...
  <div class="container mx-auto bg-gray-200 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
      ...
      <div class="relative "  style="min-height: 54vh;">
                  <div class="flex ">
                      ...
                      <button class="text-xs w-20  h-10  mt-1 sm:mt-4 md:mt-3 lg:mt-0 xl:mt-0 mx-1  text-white bg-blue-500 rounded mfont-bold hover:bg-blue-700">
                            <a href="{{ route('book.index') }}">{{ __('public.reset_search') }}</a>
                        </button>
                      </div>
